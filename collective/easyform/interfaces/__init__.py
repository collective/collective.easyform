...
#                   fields=['fields_model', 'actions_model'])
    ...
    fields_model = Text(
        ...
        default=config.config.FIELDS_DEFAULT,
    )
    actions_model = Text(
        title=_(u'Actions Model'),
        default=config.config.ACTIONS_DEFAULT,
    )
    ...
    directives.write_permission(forceSSL=config.config.EDIT_ADVANCED_PERMISSION)
    forceSSL = Bool(
    ...
    directives.write_permission(thanksPageOverrideAction=config.config.EDIT_TALES_PERMISSION)
    ...
    directives.write_permission(thanksPageOverride=config.config.EDIT_TALES_PERMISSION)
    ...
    directives.write_permission(formActionOverride=config.config.EDIT_TALES_PERMISSION)
    ...
    directives.write_permission(onDisplayOverride=config.config.EDIT_TALES_PERMISSION)
    ...
    directives.write_permission(afterValidationOverride=config.config.EDIT_TALES_PERMISSION)
    ...
    directives.write_permission(headerInjection=config.config.EDIT_TALES_PERMISSION)
    ...
    directives.write_permission(submitLabelOverride=config.config.EDIT_TALES_PERMISSION)
...
#     obj.setDescription(_(u'pfg_thankyou_description', u'Thanks for your input.'))
    ...
    showFields = List(
        ...
        unique=True,
        required=False,
        value_type=Choice(vocabulary=vocabularies.fieldsFactory),
    )
    includeEmpties = Bool(
...
class IFieldExtender(Schema):
    ...
    directives.write_permission(TDefault=config.config.EDIT_TALES_PERMISSION)
    TDefault = TextLine(
    ...
    directives.write_permission(TEnabled=config.config.EDIT_TALES_PERMISSION)
    TEnabled = TextLine(
    ...
    directives.write_permission(TValidator=config.config.EDIT_TALES_PERMISSION)
    TValidator = TextLine(
    ...
    directives.write_permission(serverSide=config.config.EDIT_TALES_PERMISSION)
    serverSide = Bool(
...
class IActionExtender(Schema):
    ...
    directives.write_permission(execCondition=config.config.EDIT_TALES_PERMISSION)
...
#     default_method='getDefaultRecipientName',
    directives.write_permission(recipient_name=config.config.EDIT_ADDRESSING_PERMISSION)
...
#     TODO IContextAwareDefaultFactory
    directives.write_permission(recipient_email=config.config.EDIT_ADDRESSING_PERMISSION)
    ...
    directives.write_permission(to_field=config.config.EDIT_ADVANCED_PERMISSION)
...
#     default_method='getDefaultCC',
    directives.write_permission(cc_recipients=config.config.EDIT_ADDRESSING_PERMISSION)
...
#     default_method='getDefaultBCC',
    directives.write_permission(bcc_recipients=config.config.EDIT_ADDRESSING_PERMISSION)
    ...
    directives.write_permission(replyto_field=config.config.EDIT_ADVANCED_PERMISSION)
    ...
    directives.write_permission(subject_field=config.config.EDIT_ADVANCED_PERMISSION)
...
#     validators=('zptvalidator',),
    directives.write_permission(body_pt=config.config.EDIT_TALES_PERMISSION)
...
#     default_method='getDefaultXInfo',
    ...
    xinfo_headers = List(
        ...
        value_type=Choice(vocabulary=vocabularies.XINFO_HEADERS),
    )
...
class ISaveData(IAction):
    ...
    ExtraData = List(
        ...
        unique=True,
        value_type=Choice(vocabulary=vocabularies.vocabExtraDataDL),
    )
